...
//! (docs/functor-lang.md; design: `~/notes/ideas/functor-lang/closures.md`).
//!
...
//! variants. Functor Lang data is acyclic (immutable values, late-bound recursion),
...
fn free_vars(expr: &Expr, bound: &mut Vec<BindingId>, free: &mut Vec<(String, BindingId)>) {
    match &expr.kind {
        ...
        ExprKind::Let {
            ...
            // Functor Lang `let` is non-recursive: the value cannot see the binding.
