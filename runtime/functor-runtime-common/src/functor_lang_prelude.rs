...
/// Milliseconds on the shared portable clock (see [`epoch_seconds`]). The
/// embedded producer times reloads/rewinds/seeks with it — one portable clock
/// instead of a platform-specific `Date::now()`.
