// CodeMirror 6 language support for MLE, plus the site's synthwave editor
// theme. The tokenizer is a small hand-rolled StreamLanguage (MLE has no
// Lezer grammar); keep the keyword list in sync with the language
// (.claude/skills/mle-language/SKILL.md is the source of truth).
...
export const mleLanguage = StreamLanguage.define({
  name: "mle",
  token(stream) {
